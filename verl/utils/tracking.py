...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = "console", config=None, resume_id: str = None):
        ...
        if "tracking" in default_backend or "wandb" in default_backend:
            ...
            wandb_kwargs = dict(project=project_name, name=experiment_name, config=config,
                                settings=wandb.Settings(console="off"))
            if resume_id:
                wandb_kwargs.update(id=resume_id, resume="must")
