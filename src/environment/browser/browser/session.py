...
from src.environment.browser.browser.cloud import CloudBrowserAuthError, CloudBrowserError, get_cloud_browser_cdp_url

# CDP logging is now handled by setup_logging() in logging_config.py
# It automatically sets CDP logs to the same level as src.environment.browser logs
...
from src.environment.browser.browser.profile import BrowserProfile, ProxySettings
from src.environment.browser.browser.views import BrowserStateSummary, TabInfo
from src.environment.browser.dom.views import EnhancedDOMTreeNode, TargetInfo
from src.environment.browser.observability import observe_debug
from src.environment.browser.utils import _log_pretty_url, is_new_tab_page

if TYPE_CHECKING:
	from src.environment.browser.actor.page import Page
...
class CDPSession(BaseModel):
	...
	async def for_target(
		...
		if new_socket:
			...
			logger = logging.getLogger(f'src.environment.browser.CDPSession.{target_id[-4:]}')
...
class BrowserSession(BaseModel):
	...
	def logger(self) -> Any:
		...
		# 	self._logger = logging.getLogger(f'src.environment.browser.{self}')
		return logging.getLogger(f'src.environment.browser.{self}')
	...
	def model_post_init(self, __context) -> None:
		...
		from src.environment.browser.browser.watchdog_base import BaseWatchdog
	...
	async def kill(self) -> None:
		...
		from src.environment.browser.browser.events import SaveStorageStateEvent
	...
	async def on_NavigateToUrlEvent(self, event: NavigateToUrlEvent) -> None:
		...
		if event.new_tab:
			try:
				...
				from src.environment.browser.utils import is_new_tab_page
	...
	async def on_BrowserStopEvent(self, event: BrowserStopEvent) -> None:
		...
		try:
			...
			if self.browser_profile.use_cloud:
				try:
					from src.environment.browser.browser.cloud import cleanup_cloud_client
	...
	async def new_page(self, url: str | None = None) -> 'Page':
		...
		from src.environment.browser.actor.page import Page as Target
	...
	async def attach_all_watchdogs(self) -> None:
		...
		from src.environment.browser.browser.watchdogs.aboutblank_watchdog import AboutBlankWatchdog

		# from src.environment.browser.browser.crash_watchdog import CrashWatchdog
		from src.environment.browser.browser.watchdogs.default_action_watchdog import DefaultActionWatchdog
		from src.environment.browser.browser.watchdogs.dom_watchdog import DOMWatchdog
		from src.environment.browser.browser.watchdogs.downloads_watchdog import DownloadsWatchdog
		from src.environment.browser.browser.watchdogs.local_browser_watchdog import LocalBrowserWatchdog
		from src.environment.browser.browser.watchdogs.permissions_watchdog import PermissionsWatchdog
		from src.environment.browser.browser.watchdogs.popups_watchdog import PopupsWatchdog
		from src.environment.browser.browser.watchdogs.recording_watchdog import RecordingWatchdog
		from src.environment.browser.browser.watchdogs.screenshot_watchdog import ScreenshotWatchdog
		from src.environment.browser.browser.watchdogs.security_watchdog import SecurityWatchdog
		from src.environment.browser.browser.watchdogs.storage_state_watchdog import StorageStateWatchdog
	...
	async def navigate_to(self, url: str, new_tab: bool = False) -> None:
		...
		"""
		from src.environment.browser.browser.events import NavigateToUrlEvent
