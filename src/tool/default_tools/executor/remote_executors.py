...
from src.tool.default_tools.executor.local_python_executor import CodeOutput, PythonExecutor
...
"""
    ...
    def _patch_final_answer_with_exception(self, final_answer_tool: Any):
...
class WasmExecutor(RemotePythonExecutor):
    ...
    def run_code_raise_errors(self, code: str) -> CodeOutput:
        ...
        try:
            ...
            raise Exception(f"Failed to communicate with Deno server: {e}")
