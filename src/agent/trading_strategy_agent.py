...
class TradingStrategyAgent(Agent):
    ...
    name: str = Field(default="trading_strategy", description="The name of the trading strategy agent.")
    description: str = Field(default="A trading strategy agent that can call tools to complete tasks.", description="The description of the trading strategy agent.")
    ...
    async def _get_messages(self, 
        ...
        diagram_path = diagram_path_backtest 
    ...
    async def __call__(self, 
        ...
        """
        Main entry point for trading strategy agent through agent_manager.
