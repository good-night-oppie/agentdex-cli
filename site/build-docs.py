...
CSS = """
:root { --bg:#FAF6F0; --surface:#F2EAD9; --border:#E0D4BC; --ink:#1F1A14; --mute:#5C5448; --accent:#C2541B; --gold:#A0531C; --term-bg:#0E0B16; --term-fg:#E8DCC2; }
...
.brand { font-family:"Playfair Display",serif; font-weight:700; letter-spacing:.12em; color:var(--ink); text-decoration:none; }
...
main h1 { font-family:"Playfair Display",serif; font-size:2.1rem; line-height:1.2; margin:.2em 0 .5em; }
main h2 { font-family:"Playfair Display",serif; font-size:1.45rem; margin-top:2em; border-bottom:1px solid var(--border); padding-bottom:.35em; }
...
main blockquote { margin:1em 0; padding:.2em 1.2em; border-left:3px solid var(--accent); color:var(--mute); background:var(--surface); border-radius:0 8px 8px 0; }
main :not(pre) > code { background:var(--surface); border:1px solid var(--border); border-radius:5px; padding:.08em .35em; font:.86em "JetBrains Mono",monospace; }
.codehilite, main pre { background:var(--term-bg); color:var(--term-fg); border-radius:10px; padding:16px 18px; overflow-x:auto; font:13.5px/1.55 "JetBrains Mono",monospace; box-shadow:0 12px 30px -18px rgba(31,26,20,.45); }
.codehilite pre, pre code { background:none; padding:0; margin:0; border:none; }
.demo-embed { margin:20px 0 28px; }
.demo-embed .frame { background:var(--term-bg); border-radius:12px; padding:14px; box-shadow:0 18px 44px -20px rgba(31,26,20,.5); }
...
.demo-embed p { font:12.5px "JetBrains Mono",monospace; color:var(--mute); margin:8px 2px 0; }
.crumbs { font:12.5px "JetBrains Mono",monospace; color:var(--mute); margin-bottom:8px; }
.crumbs a { color:var(--mute); }
.src { font:12.5px "JetBrains Mono",monospace; margin-top:48px; padding-top:16px; border-top:1px solid var(--border); color:var(--mute); }
footer.ft { border-top:1px solid var(--border); margin-top:40px; }
footer.ft .in { max-width:1200px; margin:0 auto; padding:24px; font:13px "JetBrains Mono",monospace; color:var(--mute); display:flex; justify-content:space-between; flex-wrap:wrap; gap:8px; }
.idx-group h2 { font-family:"Playfair Display",serif; border:none; margin-top:1.6em; }
