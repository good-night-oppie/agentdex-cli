...
with read_base():
    ...
    from .tools.human_capability_debate import human_capability_debate_tool
...
#-----------------HUMAN CAPABILITY DEBATE TOOL CONFIG-----------------
human_capability_debate_tool.update(
    model_name="openrouter/gemini-3-flash-preview",
    agent_models=[
    ...
    base_dir="tool/human_capability_debate",
)
