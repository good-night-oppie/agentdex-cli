...
class TradingSignalEvaluationAgent(Agent):
    """Trading strategy agent implementation with manual agent logic."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    name: str = Field(default="trading_signal_evaluation", description="The name of the trading signal evaluation agent.")
    description: str = Field(default="A trading signal evaluation agent that can call tools to complete tasks.", description="The description of the trading signal evaluation agent.")
