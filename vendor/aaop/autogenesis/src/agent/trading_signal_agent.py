...
class TradingSignalAgent(Agent):
    """Trading signal agent implementation with manual agent logic."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    name: str = Field(default="trading_signal", description="The name of the trading signal agent.")
    description: str = Field(default="A trading signal agent that can call tools to complete tasks.", description="The description of the trading signal agent.")
    metadata: Dict[str, Any] = Field(default={}, description="The metadata of the trading signal agent.")
    ...
    def __init__(
        ...
        **kwargs
        ...
        # Set default prompt name for trading signal
        if not prompt_name:
    ...
    async def _get_environment_context(self, ctx: SessionContext, record: Record = None, **kwargs) -> Dict[str, Any]:
        ...
        for env_name in ["signal_research"]:
    ...
    async def _get_messages(self, 
        ...
        diagram_path = diagram_path_signal_research
    ...
    async def __call__(self, 
        ...
        """
        Main entry point for trading signal agent through acp.
        ...
        """
        logger.info(f"| 🚀 Starting TradingSignalAgent: {task}")
        ...
        logger.info(f"| ✅ TradingSignalAgent completed after {step_number}/{self.max_steps} steps")
