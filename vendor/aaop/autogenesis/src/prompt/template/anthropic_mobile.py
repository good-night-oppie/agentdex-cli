...
class AnthropicMobileSystemPrompt(Prompt):
    """System prompt template for anthropic mobile agents."""
    ...
    description: str = Field(default="System prompt for anthropic mobile agents", description="The description of the prompt")
...
@PROMPT.register_module(force=True)
class AnthropicMobileAgentMessagePrompt(Prompt):
    """Agent message prompt template for anthropic mobile agents."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    type: str = Field(default='agent_message_prompt', description="The type of the prompt")
    name: str = Field(default="anthropic_mobile", description="The name of the prompt")
    description: str = Field(default="Agent message prompt for anthropic mobile agents", description="The description of the prompt")
    metadata: Dict[str, Any] = Field(default={}, description="The metadata of the prompt")
