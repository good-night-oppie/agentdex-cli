...
<code_signal_evaluation_generation_rules>
"""AgentSignalEvaluation Template"""

from src.environment.quickbacktest.base_types import BaseSignalEvaluation
import pandas as pd
import numpy as np
...
class AgentSignalEvaluation(BaseSignalEvaluation):
    """
    AgentSignalEvaluation
    ==============
    ...
    Thus, access to the signal data like
...
SYSTEM_PROMPT = {
    "name": "trading_signal_evaluation_system_prompt",
    "type": "system_prompt",
    "description": "System prompt for trading signal evaluation agents - static constitution and protocol",
    "require_grad": True,
...
AGENT_MESSAGE_PROMPT = {
    "name": "trading_signal_evaluation_agent_message_prompt",
    "type": "agent_message_prompt",
    "description": "Agent message for trading signal evaluation agents (dynamic context)",
    "require_grad": False,
...
class TradingSignalEvaluationSystemPrompt(Prompt):
    """System prompt template for trading signal evaluation agents."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    type: str = Field(default='system_prompt', description="The type of the prompt")
    name: str = Field(default="trading_signal_evaluation", description="The name of the prompt")
    description: str = Field(default="System prompt for trading signal evaluation agents", description="The description of the prompt")
...
@PROMPT.register_module(force=True)
class TradingSignalEvaluationAgentMessagePrompt(Prompt):
    """Agent message prompt template for trading signal evaluation agents."""
    model_config = ConfigDict(arbitrary_types_allowed=True, extra="allow")
    
    type: str = Field(default='agent_message_prompt', description="The type of the prompt")
    name: str = Field(default="trading_signal_evaluation", description="The name of the prompt")
    description: str = Field(default="Agent message prompt for trading signal evaluation agents", description="The description of the prompt")
