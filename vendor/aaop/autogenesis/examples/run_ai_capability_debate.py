...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "ai_capability_debate.py"), help="config file path")
...
async def main():
    ...
    async def run_with_semaphore(sector: str):
        ...
        async with semaphore:
            task = f"开启一个AI能力自博弈讨论，讨论主题和行业是：AI在{sector}行业的应用。"
