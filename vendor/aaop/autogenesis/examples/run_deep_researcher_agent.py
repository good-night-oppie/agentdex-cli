...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "deep_researcher_agent.py"), help="config file path")
...
async def main():
    ...
    # Example task
    task = "Search for the latest research progress on deep learning and summarize the key findings."
    files = []
