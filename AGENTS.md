...
- [Verifiable CI/CD for AI — FDE Kit](docs/design/verifiable-cicd-for-ai-fde-kit.md) — domain-agnostic self-improving-system reference: the three contracts (Genome / Gym / Cassette Ledger + Kill Gate), the layered-oracle Gym recipe + archetype playbook, TDD-not-RL statistics, Goodhart anti-rot, and the "Verifiable CI/CD for AI" framing; agentdex/bene/harness bindings + honest gaps
