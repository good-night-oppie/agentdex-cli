...
def parse_args():
    ...
    parser.add_argument("--config", default=os.path.join(root, "configs", "deep_analyzer_agent.py"), help="config file path")
...
async def main():
    ...
    # Example task
    task = "What are the names of the Pokémon in the image?"
    files = [
        os.path.join(root, "tests/files/pokemon.jpg")
    ]
